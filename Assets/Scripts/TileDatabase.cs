...
public class TileDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        tileList.Add(new Tile(0, "0p", "5", getSpriteByName("0p")));
        tileList.Add(new Tile(1, "1p", "1", getSpriteByName("1p")));
        tileList.Add(new Tile(2, "2p", "2", getSpriteByName("2p")));
        tileList.Add(new Tile(3, "3p", "3", getSpriteByName("3p")));
        tileList.Add(new Tile(4, "4p", "4", getSpriteByName("4p")));
        tileList.Add(new Tile(5, "5p", "5", getSpriteByName("5p")));
        ...
        tileList.Add(new Tile(10, "0s", "5", getSpriteByName("0s")));
        tileList.Add(new Tile(11, "1s", "1", getSpriteByName("1s")));
        tileList.Add(new Tile(12, "2s", "2", getSpriteByName("2s")));
        tileList.Add(new Tile(13, "3s", "3", getSpriteByName("3s")));
        tileList.Add(new Tile(14, "4s", "4", getSpriteByName("4s")));
        tileList.Add(new Tile(15, "5s", "5", getSpriteByName("5s")));
        ...
        tileList.Add(new Tile(20, "0m", "5", getSpriteByName("0m")));
        tileList.Add(new Tile(21, "1m", "1", getSpriteByName("1m")));
        tileList.Add(new Tile(22, "2m", "2", getSpriteByName("2m")));
        tileList.Add(new Tile(23, "3m", "3", getSpriteByName("3m")));
        tileList.Add(new Tile(24, "4m", "4", getSpriteByName("4m")));
        tileList.Add(new Tile(25, "5m", "5", getSpriteByName("5m")));
