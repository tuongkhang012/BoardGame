...
public class TileDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        tileList.Add(new Tile(5, "6p", "6", getSpriteByName("6p")));
        tileList.Add(new Tile(6, "7p", "7", getSpriteByName("7p")));
        tileList.Add(new Tile(7, "8p", "8", getSpriteByName("8p")));
        tileList.Add(new Tile(8, "9p", "9", getSpriteByName("9p")));

        tileList.Add(new Tile(9, "0p", "5", getSpriteByName("0p")));
        ...
        tileList.Add(new Tile(15, "6s", "6", getSpriteByName("6s")));
        tileList.Add(new Tile(16, "7s", "7", getSpriteByName("7s")));
        tileList.Add(new Tile(17, "8s", "8", getSpriteByName("8s")));
        tileList.Add(new Tile(18, "9s", "9", getSpriteByName("9s")));

        tileList.Add(new Tile(19, "0s", "5", getSpriteByName("0s")));
        ...
        tileList.Add(new Tile(25, "6m", "6", getSpriteByName("6m")));
        tileList.Add(new Tile(26, "7m", "7", getSpriteByName("7m")));
        tileList.Add(new Tile(27, "8m", "8", getSpriteByName("8m")));
        tileList.Add(new Tile(28, "9m", "9", getSpriteByName("9m")));

        tileList.Add(new Tile(29, "0m", "5", getSpriteByName("0m")));
